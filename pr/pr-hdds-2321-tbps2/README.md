...
## integration check is finished with failure status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-tbps2/integration/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/integration)
   * [summary.md](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/integration/summary.md)
   * [summary.txt](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/integration/summary.txt)
...
## unit check is finished with failure status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-tbps2/unit/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/unit)
   * [summary.md](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/unit/summary.md)
   * [summary.txt](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/unit/summary.txt)
...
## acceptance check is finished with failure status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-tbps2/acceptance/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/acceptance)


## rat check is finished with failure status

   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-tbps2/rat/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/rat)
   * [summary.txt](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/rat/summary.txt)
...
## checkstyle check is finished with failure status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-tbps2/checkstyle/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/checkstyle)
   * [summary.txt](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/checkstyle/summary.txt)
...
## findbugs check is finished with failure status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-tbps2/findbugs/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/findbugs)
   * [summary.html](https://elek.github.io/ozone-ci-03/pr/pr-hdds-2321-tbps2/findbugs/summary.html)
   * [summary.txt](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/findbugs/summary.txt)
...
## checkout check is finished with success status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-tbps2/checkout/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/checkout)


## build check is finished with success status

   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-tbps2/build/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/build)


## author check is finished with success status

   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-tbps2/author/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/author)
 ...
 * All the results are saved to [here](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-tbps2/)
