...
## findbugs check is finished with failure status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-qqxqq/findbugs/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/findbugs)
   * [summary.html](https://elek.github.io/ozone-ci-03/pr/pr-hdds-2321-qqxqq/findbugs/summary.html)
   * [summary.txt](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/findbugs/summary.txt)
...
## acceptance check is finished with failure status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-qqxqq/acceptance/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/acceptance)


## checkstyle check is finished with failure status

   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-qqxqq/checkstyle/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/checkstyle)
   * [summary.txt](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/checkstyle/summary.txt)
...
## rat check is finished with failure status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-qqxqq/rat/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/rat)
   * [summary.txt](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/rat/summary.txt)
...
## unit check is finished with failure status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-qqxqq/unit/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/unit)
   * [summary.md](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/unit/summary.md)
   * [summary.txt](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/unit/summary.txt)
...
## integration check is finished with failure status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-qqxqq/integration/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/integration)
   * [summary.md](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/integration/summary.md)
   * [summary.txt](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/integration/summary.txt)
...
## author check is finished with success status
   ...
   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-qqxqq/author/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/author)


## build check is finished with success status

   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-qqxqq/build/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/build)


## checkout check is finished with success status

   * [output](https://raw.githubusercontent.com/elek/ozone-ci-03/master/pr/pr-hdds-2321-qqxqq/checkout/output.log)
   * [all collected results](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/checkout)
 ...
 * All the results are saved to [here](https://github.com/elek/ozone-ci-03/tree/master/pr/pr-hdds-2321-qqxqq/)
